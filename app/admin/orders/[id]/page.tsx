...
export default function AdminOrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="px-8 py-8 max-w-4xl">
      <Link href="/admin/orders" className="inline-flex items-center gap-2 font-sans text-[10px] tracking-[0.2em] uppercase text-zinc-300 hover:text-zinc-600 transition-colors mb-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-zinc-100 rounded-2xl overflow-hidden">
            ...
            <div className="px-5 py-4 border-t border-zinc-50 space-y-1.5">
              ...
              <div className="flex justify-between font-sans text-sm font-medium text-zinc-900">
