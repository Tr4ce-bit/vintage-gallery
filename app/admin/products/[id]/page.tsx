...
export default function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    async function load() {
      ...
      // images array: first element is primary (imageUrl), rest are additional
  ...
  if (notFound) return (
    <div className="px-8 py-8">
      <p className="font-sans text-sm text-zinc-400">Product not found.</p>
    </div>
  );
  ...
  return (
    <div className="px-8 py-8">
      ...
      <h1 className="font-serif text-zinc-900 mb-8" style={{ fontSize: "2rem", fontWeight: 300 }}>
        Edit Product
      </h1>
