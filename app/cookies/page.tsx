...
const COOKIE_TABLE = [
  ...
  {
    name:     "vg-session-id (localStorage)",
    provider: "Vintage Gallery",
    purpose:  "A randomly generated ID that lets us count how many separate visits a product page receives, without identifying you. It is sent to our own servers alongside product interactions. It is never linked to your account, name or email, and is never shared with anyone.",
        ...
        <div className="max-w-3xl mx-auto px-5 md:px-8 py-14">
          ...
          <div className="space-y-10 font-sans text-sm text-zinc-600 dark:text-zinc-400 font-light leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-3">
                Some data is stored in <strong className="font-medium text-zinc-700 dark:text-zinc-300">localStorage</strong>, which works similarly. Your cart and theme preference stay on your device only. One item — a randomly generated visit ID — is sent to our own servers so we can count product page visits; details are in the table below.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We use <strong className="font-medium text-zinc-700 dark:text-zinc-300">essential and functional cookies</strong>, plus a small amount of <strong className="font-medium text-zinc-700 dark:text-zinc-300">first-party analytics</strong>. We do not use advertising cookies, cross-site tracking, or sell any data to third parties.
              </p>
              <p className="mt-3">
                We do not use Google Analytics or any advertising pixels. Our analytics are built in-house and stay on our own servers.
              </p>
              <p className="mt-3">
                <strong className="font-medium text-zinc-700 dark:text-zinc-300">What we measure:</strong> which products are viewed, roughly how long a product page is open, and when an item is added to or removed from a cart or wishlist. Each event carries only a random ID generated by your browser — never your name, email, or account. We use it to understand which pieces people are interested in. Clearing your browser storage resets the ID and breaks any link to your previous visits.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                To clear your localStorage (cart, theme, and analytics visit ID), you can clear your browser&apos;s site data for vintagegallery.store.
              </p>
            </section>
