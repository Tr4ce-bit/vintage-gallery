    ...
    <>
      <main className="min-h-screen bg-white pt-[60px]">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 pt-8 pb-0">
          <Link href="/shop" className="inline-flex items-center gap-2 font-sans text-[10px] tracking-[0.2em] uppercase text-zinc-400 hover:text-zinc-900 transition-colors group">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2.5 font-sans font-medium text-[11px] tracking-[0.18em] uppercase py-3.5 rounded-full transition-all duration-300 ${
                  added
